...
fluidPage(
  ...
  tags$table(
    tags$tr(
      ...
      tags$tr(
        tags$td(align="center",
          checkboxInput("game_type","Marathon Mode",width = '150%')
        )
      )
    ,align="center")
  )
  ,align="center"),
  p(strong("Regular Mode:")," choose number of questions, try get as many of them correct as possible"),
  p(strong("Marathon Mode:")," see how far you can go, game will continue until a mistake is made"),
  br(),
  tags$div(actionButton("launch","start game",align="center"),align="center"), # command button to start the game
